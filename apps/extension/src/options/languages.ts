...
export const LANGUAGE_OPTIONS: LanguageOption[] = [
  {
    ...
    nativeName: "English",
    promptName: "English",
    aliases: ["american english", "british english"]
  },
  {
    code: "zh-TW",
    ...
    aliases: ["taiwan chinese", "繁中", "中文", "chinese traditional"]
  },
  {
    code: "zh-CN",
    ...
    aliases: ["mainland chinese", "简中", "中文", "chinese simplified"]
  },
  {
    code: "ja",
    name: "Japanese",
  ...
  },
  {
    ...
    aliases: ["portuguese", "brazil portuguese", "portugues"]
  },
  {
    code: "pt-PT",
    ...
    aliases: ["portuguese portugal", "portugues"]
  },
  {
    code: "nl",
    name: "Dutch",
...
export function getPreferredLanguageOption(
